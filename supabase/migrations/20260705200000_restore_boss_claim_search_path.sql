-- ============================================================
-- Restaure le SET search_path perdu par erreur lors du correctif du webhook Discord (voir
-- 20260705190100_boss_claim_via_edge_function.sql) -- releve par un audit de securite de suivi
-- (2026-07-05). Sans ce SET, la fonction est vulnerable a une attaque par search_path si un
-- attaquant parvenait a creer des objets similaires dans un autre schema du role appelant.
--
