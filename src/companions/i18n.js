...
// Switcher de langue propre au module RETIRÉ (2026-07-19) : la langue se change uniquement via le
// sélecteur FR/EN du header du jeu (un seul contrôle, plus cohérent). Ce header écrit la clé PARTAGÉE
// velia-idle-lang puis recharge cette iframe (applyI18n, src/core/i18n-legacy.js), qui relit la langue
// à l'init (COMPANIONS_LANG) -- pas besoin d'un setCompanionLang ici.
